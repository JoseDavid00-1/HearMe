...
<body>
    <div class="container  bg-light mt-5 pb-5 rounded shadow ">
         <h3  class="text-center fw-bold py-3"> Área administrativa</h3>
                 ...
                 <div class="row"> 
                        <div class="col-md-3">
                            <form action="insertar_user.php" method="GET" >
                            ...
                            <table BORDER CELLPADDING=10 style = "font-family:verdana;"   >
                                ...
                                <?php
                                            ...
                                            <tr style="border: 1px solid black">
                                                ...
                                                <td style="border: 1px solid black"><?php echo $mostrar['nombre']?></td>
                                                <td style="border: 1px solid black"><?php echo $mostrar['apellido']?></td>
                                                <td style="border: 1px solid black"><?php echo $mostrar['correo']?></td>
                                                
                                                <td><?php echo "<a href='http://localhost:8081/IS2/admin/usuarios/editar_usuario.php?no=".$mostrar['usuario']."' class='btn btn-primary'>";
                                                echo "Editar";
                                                echo"</a>"?>
                                                </td>
                                                <td><?php echo "<a href='http://localhost:8081/IS2/admin/usuarios/eliminar_usuario.php?no=".$mostrar['usuario']."' class='btn btn-primary'>";
                                                echo "Eliminar";
                                                echo"</a>"?>
                                                </td>
                                            </tr>
