...
<body>
    <div class="container  bg-light mt-5 pb-5 rounded shadow ">
        <a class="mt-2"style="text-decoration: none;" href="./admins.php" role="button">Regresar</a>
    <h3  class="text-center fw-bold py-3"> <?php echo $tema ?></h3>
        <div class="formulario" >
                    <form action="contenido_agregar.php" method="GET" >
                        
                        
                        <input type="hidden" name ="id" value="<?php echo $tema ?>" ><br/>
